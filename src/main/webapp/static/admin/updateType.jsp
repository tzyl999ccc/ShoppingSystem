...
<div id="addAll">
    ...
    <div id="table">
        <form action="${pageContext.request.contextPath}/type/update.action" enctype="multipart/form-data" method="post" id="myform">
...
<%--            <input type="hidden" value="${prod.pImage}" name="pImage">--%>
            ...
            <table>
                ...
                <tr>
                    ...
                    <td><input type="text" name="typeId" class="two" value="${prod.typeId}"></td>
                </tr>
                <!--错误提示-->
                <tr class="three">
                    <td class="four"></td>
                ...
                <tr>
                    ...
                    <td><input type="text" name="typeName" class="two" value="${prod.typeName}"></td>
                </tr>
                <!--错误提示-->
                <tr class="three">
                    <td class="four"></td>
