...
<div id="brall">
    ...
    <div id="condition" style="text-align: center">
        <form id="myform">
            ...
            <c:forEach items="${allType}" var="pt">
        ...
        <c:choose>
            <c:when test="${pb.list.size()!=0}">
                ...
                <div id="top">
                    ...
                    <a href="${pageContext.request.contextPath}/prod/addProduct.action">
                ...
                <form action="${pageContext.request.contextPath}/admin/product?flag=save" enctype="multipart/form-data"
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <button type="button" class="btn btn-info" data-dismiss="modal" onclick="myclose(1)">取消</button>
                            </td>
                        </tr>
                    </table>
                </form>
