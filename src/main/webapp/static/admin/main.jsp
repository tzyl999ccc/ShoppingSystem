				...
				<div id="bleft">
					...
					<div id="lbottom">
						<ul>
							...
							<a href="${pageContext.request.contextPath}/type/productType.action" target="myright" >
								<li class="two"><span class="glyphicon glyphicon-book" style="color: white;"></span>&nbsp;&nbsp;&nbsp;&nbsp;类别管理&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="glyphicon glyphicon-play" style="color: white;"></span> </li>
							</a>
							<a href="${pageContext.request.contextPath}/order/productInfoOrderManagement.action" target="myright">
							...
							<a href="${pageContext.request.contextPath}/user/userManagement.action" target="myright">
							...
							<a href="${pageContext.request.contextPath}/admin/err.action" target="myright">
							...
							<a href="${pageContext.request.contextPath}/admin/logout.action">
								<li class="one"><span class="glyphicon glyphicon-bullhorn" style="color: white"></span>&nbsp;&nbsp;&nbsp;&nbsp;退出&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="glyphicon glyphicon-play" style="color: white;"></span> </li>
							</a>
						</ul>
					</div>
				</div>
