...
<html>
	...
	<body>
		<div id="login">
			<div id="top">
				<img src="${pageContext.request.contextPath}/image_big/cloud.jpg" /><span>LOGIN</span>
			</div>
			<div id="bottom">
					...
					<table border="0px" id="table">
						...
						<tr>
							...
							<td><input type="submit" value="登录" class="td3">
								<button type="button" class="btn btn-primary" data-dismiss="modal" id="JumpBtn">跳转到用户主页面</button>
							</td>
							<td>
