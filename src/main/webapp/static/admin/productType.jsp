...
<script type="text/javascript">
    function myclose(ispage) {
        window.location="${pageContext.request.contextPath}/type/productType.action?ispage="+ispage;
        //window.close();
    }
</script>
<body>
<div id="brall">
    ...
    <div id="condition" style="text-align: center">
        <form id="myform">
            商品类型id：<input name="typeid" id="typeid">&nbsp;&nbsp;&nbsp;
            商品类型名称：<input name="typename" id="typename">&nbsp;&nbsp;&nbsp;
...
<%--                                <td>${p.pNumber}</td>--%>
<%--                                    &lt;%&ndash;<td><a href="${pageContext.request.contextPath}/admin/product?flag=delete&pid=${p.pId}" onclick="return confirm('确定删除吗？')">删除</a>&ndash;%&gt;--%>
<%--                                    &lt;%&ndash;&nbsp;&nbsp;&nbsp;<a href="${pageContext.request.contextPath}/admin/product?flag=one&pid=${p.pId}">修改</a></td>&ndash;%&gt;--%>
                                <td>
                                    <button type="button" class="btn btn-info "
                                            onclick="one(${p.typeId},${pb.pageNum})">编辑
                                    </button>
                                    <button type="button" class="btn btn-warning" id="mydel"
                                            onclick="del(${p.typeId},${pb.pageNum})">删除
                                    </button>
                                </td>
                            </tr>
                        </c:forEach>
...
<script type="text/javascript">
    function ajaxsplit(page) {
        ...
        $.ajax({
            type: "post",
            url: "${pageContext.request.contextPath}/type/ajaxsplit.action",
            data: {
                "page": page,
                "typeid":typeid,
                "typename":typename,
