...
<body>
	...
	<div class="main_wrap clearfix">
		...
		<div class="r_wrap fr clearfix">
			...
			<ul class="pagination">
				<li><a
						href="${pageContext.request.contextPath}/user/productInfo_location_list.action?pname=${pName}&page=1&size=5"
						aria-label="Previous">首页</a></li>
				<li><a
						href="${pageContext.request.contextPath}/user/productInfo_location_list.action?pname=${pName}&page=${pageInfos.pageNum-1}&size=5">上一页</a></li>
				<c:forEach begin="1" end="${pageInfos.pages}" var="pageNumber">
					<li><a
							href="${pageContext.request.contextPath}/user/productInfo_location_list.action?pname=${pName}&page=${pageNumber}&size=5">${pageNumber}</a></li>
				</c:forEach>
				<li><a
						href="${pageContext.request.contextPath}/user/productInfo_location_list.action?pname=${pName}&page=${pageInfos.pageNum+1}&size=5">下一页</a></li>
				<li><a
						href="${pageContext.request.contextPath}/user/productInfo_location_list.action?pname=${pName}&page=${pageInfos.pages}&size=5"
