...
<div id="addAll">
    ...
    <div id="table">
        <form action="${pageContext.request.contextPath}/type/save.action" enctype="multipart/form-data"
              method="post" id="myform">
            <table>
                <tr>
                    <td class="one">商品类型id</td>
                    <td><input type="text" name="typeId" class="two"></td>
                </tr>
                <!--错误提示-->
                <tr class="three">
                    <td class="four"></td>
                    ...
                    <td>
                        ...
                        <script type="text/javascript">
                            function myclose(ispage) {
                                window.location="${pageContext.request.contextPath}/type/productType.action?page="+ispage;
                            }
                        </script>
                    </td>
                </tr>
